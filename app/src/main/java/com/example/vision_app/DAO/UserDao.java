...
public class UserDao {
    ...
    public boolean updateTen(String userName, String ten) {
        ContentValues values = new ContentValues();
        values.put("name", ten);
        int rowsAffected = db.update("user", values, "user_name=?", new String[]{userName});
        return rowsAffected > 0;
    ...
    public boolean updatediaChi(String userName, String diaChi) {
        ContentValues values = new ContentValues();
    ...
    public boolean updateSdt(String userName, String sdt) {
        ContentValues values = new ContentValues();
        values.put("n_phone", sdt);
        int rowsAffected = db.update("user", values, "user_name=?", new String[]{userName});
        return rowsAffected > 0;
    }

    public boolean updateNgaySinh(String userName, String ngaySinh) {
        ContentValues values = new ContentValues();
        values.put("date", ngaySinh);
        int rowsAffected = db.update("user", values, "user_name=?", new String[]{userName});
        return rowsAffected > 0;
    }
    ...
    public String getPasswordByUsername(String username) {
        /*
         * Lấy mật khẩu theo tên người dùng (username)
         * */
