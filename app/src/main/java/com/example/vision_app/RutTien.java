        ...
        */
        ...
        if (role == 0){
            ...
            btn_xacNhanRut.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    /*
                     * 1.Cập nhật lại stk của user trong csdl ( số dư tk user - số tiền rút, theo tài khoản đăng nhập)
                    ...
                    if(withdrawDAO.updateStatusWithdraw(1,objWithdraw.getId_withdraw())){
                        userDao.updateMoney(objWithdraw.getUser_name(), userDao.getSoDuTK(objWithdraw.getUser_name())- objWithdraw.getWithdraw_amount());
